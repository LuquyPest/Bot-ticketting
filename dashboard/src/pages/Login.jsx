    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-slate-500 mt-1">Connecte-toi avec ton compte Discord</p>
        </div>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
          <a
            ...
            className="flex items-center justify-center gap-3 w-full py-3 px-4 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-medium text-sm transition-colors shadow-lg shadow-indigo-600/20"
          >
